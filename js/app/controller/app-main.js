        ...
        getInfo: function(callback) {
            getResource(
                ...
                function(data) {
                    ...
                    /*
                    //console.log("SHOULD FING <"+ JSON.stringdata.show_name + "w");
...
//console.log(JSON.stringify(WSBF.playlist));
...
WSBF.namespace("WSBF.charts");

WSBF.charts = (function(){
    var _url = "api/charts/charts.php";
    return{
        getCharts: function(prev_week_start, week_start, week_end, callback){
            var pdata = {
